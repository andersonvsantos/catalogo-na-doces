...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen bg-[#FFFDFD] text-[#5C3A3F] flex flex-col font-sans antialiased overflow-x-hidden">
      
    {/* ================= ONDAS DE FUNDO ORGÂNICAS E FLUIDAS (SEM QUEBRAS) ================= */}
    {/* Onda Superior Esquerda (Suave e arredondada no topo) */}
    <div className="absolute top-0 left-0 w-[180px] sm:w-[280px] md:w-[420px] text-[#FFE3E6] pointer-events-none z-0 select-none opacity-90 animate-na-float">
      <svg viewBox="0 0 300 400" fill="currentColor" className="w-full h-auto">
        <path d="M 0,0 
                L 220,0 
                C 270,80 230,160 160,210 
                C 100,250 80,320 0,380 Z" />
      </svg>
    </div>

    {/* Onda Lateral Direita - Meio (Gota suave e orgânica que flutua na lateral) */}
    <div className="absolute top-[30%] right-0 w-[140px] sm:w-[220px] md:w-[350px] text-[#FFE3E6] pointer-events-none z-0 select-none opacity-90 animate-na-float">
      <svg viewBox="0 0 200 500" fill="currentColor" className="w-full h-auto">
        <path d="M 200,50 
                C 120,90 60,170 80,250 
                C 100,330 110,410 200,450 Z" />
      </svg>
    </div>

    {/* Onda Inferior Esquerda (Suave subida na base) */}
    <div className="absolute bottom-[5%] left-0 w-[150px] sm:w-[240px] md:w-[320px] text-[#FFE3E6] pointer-events-none z-0 select-none opacity-90 animate-na-float">
      <svg viewBox="0 0 200 400" fill="currentColor" className="w-full h-auto">
        <path d="M 0,100 
                C 90,140 110,220 70,300 
                C 40,350 20,380 0,400 Z" />
      </svg>
    </div>
    {/* ==================================================================== */}

      <div className="relative z-10 flex flex-col min-h-screen animate-na-fade-up">
              ...
              <div className="text-center max-w-xl mx-auto mb-10">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-white/90 border border-pink-100 rounded-full px-6 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#D9828F]/40 transition text-center text-[#5C3A3F] placeholder-[#5C3A3F]/50 shadow-sm"
                  />
                </div>
              </div>
                ...
                {categorias.map((cat) => (
                  <button
                    ...
                    className={`px-5 py-2 rounded-full text-xs font-bold tracking-wide uppercase transition ${
                      selectedCategory === cat ? 'bg-[#D9828F] text-white shadow-sm' : 'bg-[#FFF5F6]/80 text-[#5C3A3F] hover:bg-pink-100 backdrop-blur-sm'
                    }`}
                  >
                    {cat}
                  </button>
        ...
        {/* Barra Flutuante de Subtotal Fixo */}
        ...
        {/* Footer (Corrigido com relative e z-10 para ficar à frente das ondas) */}
        <footer className="relative z-10 w-full bg-[#FFF5F6]/40 border-t border-pink-100/50 py-10 px-6 mt-auto">
